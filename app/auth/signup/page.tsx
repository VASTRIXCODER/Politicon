    ...
    <div className="min-h-screen relative flex">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center p-16 relative z-10">
        <div className="text-center">
          ...
          <p className="font-mono-data text-4xl font-bold gradient-text-gold mb-8">$4,200/year</p>
          <p className="text-text-muted text-xs mb-10 max-w-xs mx-auto">average annual impact discovered per user across tracked policies</p>
          <ImpactCardDemo />
        </div>
      </div>
    </div>
